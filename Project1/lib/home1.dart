...
import 'package:project1/anemia.dart';
import 'package:project1/cholesterol.dart';
                ...
                children: <TextSpan>[
                  TextSpan(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 15, // Larger font size for "Welcome to"
                      color: Colors.green,
                    ),
                  ),
                  TextSpan(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 18, // Larger font size for "Diagnose Me"
...
class MyDropdownMenuWidget extends StatefulWidget {
  const MyDropdownMenuWidget({super.key});
...
class _MyDropdownMenuWidgetState extends State<MyDropdownMenuWidget> {
  List<String> pages = ["diabetes", "cholesterol", "anemia"];
      ...
      onSelected: (selectedValue) {
        setState(() {
          if (selectedValue == "diabetes") {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => diabetes()));
          } else if (selectedValue == "cholesterol") {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => cholesterol()));
          } else {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => anemia()));
          }
        });
      }, // the list map function converts the list of cars to a list of DropdownMenuEntries
      dropdownMenuEntries: pages.map<DropdownMenuEntry<String>>((page) {
